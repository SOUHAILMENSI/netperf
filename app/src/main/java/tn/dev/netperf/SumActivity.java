...
public class SumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(SumActivity.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
            ...
            Statusvalue.setText(R.string.gpsnotready);
            ...
            Statusvalue.setText(R.string.gpsready);
            getLocation();
                ...
                public void onComplete(Task<Location> task) {
                    ...
                    if (location != null) {
                        ...
                        try {
                            ...
                            textView.setText(String.valueOf(addresses.get(0).getLatitude()).substring(0,9));
